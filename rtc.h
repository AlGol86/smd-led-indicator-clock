...
#define PORT_RTC_RST GPIOF
#define PORT_RTC_DAT GPIOB
#define PORT_RTC_CLK GPIOB

#define PIN_dat_rtc     3   //port B
#define PIN_clk_rtc     2   //port B
#define PIN_rst_rtc     4   //port F
